...
To conclude, `0` in front of the chmod (e.g. `chmod 0777`) works for directories only, for files - it is ignored. The `0` itself means a specific permission assigned - a directory in which the deletion of files is NOT restricted.
